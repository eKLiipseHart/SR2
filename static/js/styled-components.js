...
.skillTree select {
  position: absolute;
  left: 5px;
  top: 5px;                 /* optional: small offset from top */
  background: #0089a5;
  border: none;
  color: #ffffff;
  font-weight: bold;
  ...
  width: calc(100% - 10px); /* make it nearly full width inside container */
}

/* Responsive adjustments for mobile */
@media only screen and (max-width: 968px) {
  .skillTree select {
    max-height: 200px;      /* slightly smaller for smaller screens */
    font-size: 0.8rem;      /* fit text better */
    width: calc(100% - 10px);
  }
}
